<?php /* Smarty version Smarty-3.0.9, created on 2012-10-24 12:27:17
         compiled from "../smarty/template/home_logged.tpl" */ ?>
<?php /*%%SmartyHeaderCode:214185087c285bf81b4-25095245%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ebe45d457ae50073caefd8cd4390fbbb96b52c0b' => 
    array (
  ...
  'nocache_hash' => '214185087c285bf81b4-25095245',
  'function' => 
  array (
  ),
...
<head>
	...
	<link rel="stylesheet" href="public/css/resetStyle.css" />
	<link rel="stylesheet" href="public/css/style.css" />
	<link rel="stylesheet" href="public/css/jquery-sortable.css" />
	<link rel="stylesheet" href="inettus/inettuts.css" />
	<link rel="stylesheet" href="inettus/inettuts.js.css" />
	...
	<script type="text/javascript" src="inettus/jquery-ui-personalized-1.6rc2.min.js"></script>
	<script type="text/javascript" src="inettus/inettuts.js" />
	...
	<script type="text/javascript" src="../libs/js/jquery-ui/jquery.ui.sortable.js"></script>
	<script type="text/javascript" src="../libs/js/jquery-ui/jquery.ui.selectable.js"></script>
	...
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.effects.core.js"></script>
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.effects.bounce.js"></script>
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.effects.explode.js"></script>
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.effects.blind.js"></script>
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.effects.clip.js"></script>
	<!-- Widget -->
	<script type="text/javascript"
		src="http://localhost/sleeping/ReverseProject/libs/js/jquery-ui/jquery.ui.accordion.js"></script>
</head>
<body >
	<!-- inizio sessione -->
